  ...
  return (
    <div className='flex flex-1 flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'>
      ...
      <form onSubmit={onsubmit}  className='bg-primary/20 dark:bg-[#583C79] border border-primary dark:border-[#80609F]/30 rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center'>
       ...
       <input onChange={(e)=>setPrompt(e.target.value)} type="text" value={prompt} placeholder='Type Your prompt here.....' className='flex-1 w-full text-sm outline-none' required/>
